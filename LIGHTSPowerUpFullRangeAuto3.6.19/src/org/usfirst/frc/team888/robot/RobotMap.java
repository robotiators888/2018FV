...
public class RobotMap {
	...
	public static double fastRainbow = -0.89, solidRed = 0.61, breathingRed = -0.17, strobeGold = -0.07;
	public static double[] colorArray = {fastRainbow, solidRed, breathingRed, strobeGold};
