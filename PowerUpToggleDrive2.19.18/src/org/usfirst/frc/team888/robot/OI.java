...
public class OI {
	...
	//Returns true if button is pressed
	public boolean getLeftStickButtonPressed(int button) {
		return leftStick.getRawButtonPressed(button);
	}
	
	//Returns true if button is pressed
	public boolean getRightStickButtonPressed(int button) {
		return rightStick.getRawButtonPressed(button);
	}
	//Returns true if button is pressed
