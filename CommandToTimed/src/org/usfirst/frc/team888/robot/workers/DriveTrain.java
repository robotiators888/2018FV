...
public class DriveTrain {
    ...
    private DriveTrain() {
        // Declares the motors as objects of the TalonSRX class and passes them
        // their CAN bus IDs
        ...
        rearRight.configSelectedFeedbackSensor(FeedbackDevice.QuadEncoder, 0,
                0);
    }
     ...
     * 
     * @param leftSpeed
     *            Percent output for the two left motors
     * @param rightSpeed
     *            Percent output for the two right motors
     */
