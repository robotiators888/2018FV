...
public class WaypointTravel {
     ...
     */
    public boolean goToWaypoint(double desiredX, double desiredY,
            double desiredHeading, double speed) {
        ...
        double headingDifference = DeadReckon
        ...
        case 0:
            ...
            break;
        case 1:
            // If the difference in the actual and desired headings is greater
            // than pi radians...
        ...
        // SmartDashboard.putNumber("waypoint heading",
     ...
     *            The X position of the waypoint
     * @param desiredY
     * @return The left and right adjustments to add to get the robot to the
     *         waypoint
     */
    public double[] moveToWaypoint(double desiredX, double desiredY,
        ...
        if (direction.equals("forward")) {
            ...
            if (DeadReckon.modAngle(heading - targetData[0]) >= DeadReckon
                    .modAngle(targetData[0] - heading)) {
                ...
                adjustments = ((speed + targetData[1]) <= 1)
                        ...
                        : new double[] { 1 - speed,
                                -(targetData[1] - (1 - speed)) };

            }

            // If the heading is to the left of the robot's current heading...
            else if (DeadReckon.modAngle(heading - targetData[0]) < DeadReckon
                    .modAngle(targetData[0] - heading)) {
                ...
                adjustments = (speed + targetData[1]) <= 1
                        ...
                        : new double[] { -(targetData[1] - (1 - speed)),
                                1 - speed };
            }
        }
        ...
        // If the robot is going backward...
            ...
            // If the heading is to the right of the robot's current heading...
            if (DeadReckon.modAngle(course - targetData[0]) <= DeadReckon
                    .modAngle(targetData[0] - course)) {
            ...
            // If the heading is to the right of the robot's current heading...
            else if (DeadReckon.modAngle(course - targetData[0]) > DeadReckon
                    .modAngle(targetData[0] - course)) {
     ...
     * @param desiredHeading
     *            The heading of the waypoint
     * @return The speeds to turn the robot in place to get it to the correct
     *         heading
     */
    public double[] moveToOrientation(double desiredHeading, double speed) {
        ...
        turn = (DeadReckon.modAngle(heading - desiredHeading) >= DeadReckon
                .modAngle(desiredHeading - heading))
     ...
     * @param desiredY
     *            The Y position of the waypoint
     * @return An array with the heading the robot should travel and the
     *         adjustment to add to the motor output
     */
    public double[] calculateTurn(double desiredX, double desiredY,
        ...
        double desiredHeading = DeadReckon
                .modAngle(Math.atan2(desiredX - pos[0], desiredY - pos[1]));
