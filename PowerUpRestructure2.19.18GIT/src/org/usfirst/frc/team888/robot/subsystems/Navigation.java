...
public class Navigation extends Subsystem {
	...
	public void autoRun() {
		...
		if ((Math.abs(RobotMap.DESIRED_LOCATION[0] - pos[0]) > 15) && 
				(Math.abs(RobotMap.DESIRED_LOCATION[1] - pos[1]) > 15) || time > 8) {
			...
			SmartDashboard.putNumber("leftOutput", RobotMap.LEFT_AUTO_SPEED + adjustments[0]);
			SmartDashboard.putNumber("rightOutput", RobotMap.RIGHT_AUTO_SPEED + adjustments[1]); 
		} else {
			drive.move(0.0, 0.0);
		}
		/*
