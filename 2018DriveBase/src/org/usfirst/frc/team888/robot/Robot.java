...
public class Robot extends TimedRobot {
	...
	public static DriveStraight straight;
	...
	public void autonomousPeriodic() {
		Scheduler.getInstance().run();
		double[] adjustmentsToAdd = straight.driveStraight(straight.getLeftEncoder(), straight.getRightEncoder());
		drive.move(0.5+adjustmentsToAdd[0], 0.5+adjustmentsToAdd[1]);
	}
